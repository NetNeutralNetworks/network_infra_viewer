...
class ServiceView(BaseView):
    ...
    def list_services(self):
        ...
        help = """
            ...
            """
        return self.render_template('single_column_table.html', table_header="Service</td><td>#Devices</td><td>Average security</td><td>Average reliabilty</td><td>Average management", entries=lines, page_info=help, page_category='Network Components')
    ...
    def show_service(self, vpn):
        ...
        help = """
            ...
            <p>This data is provided by the CSPC collector.</p>
            """
        return self.render_template('single_column_table_with_map.html', table_header=f"Devices with {vpn} configured</td><td>Security</td><td>Reliabilty</td><td>Management", entries=lines, page_info=help, markers=markers, page_category='Network Components')
