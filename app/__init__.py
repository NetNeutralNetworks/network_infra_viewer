...
appbuilder.add_view(DevicesOverview, "Devices", category='Network Components', icon='fa-display')
appbuilder.add_view(ServiceView, "Services", category='Network Components', icon='fa-circle-nodes')
appbuilder.add_view(LocationView, "Locations", category='Network Components', icon='fa-location-dot')
appbuilder.add_view(HardwareView, "Hardware", category='Network Components', icon='fa-server')
appbuilder.add_view(ObjectTypeView, "Object types", category='Network Components', icon='fa-grid')
