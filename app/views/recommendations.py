...
class RecommendationView(BaseView):
    ...
    def list_recommendations(self):
        ...
        help = """
            ...
            """
        return self.render_template('single_column_table.html', table_header="Group</td><td>#Devices</td><td>Average security</td><td>Average reliabilty</td><td>Average management", entries=lines, page_info=help, page_category='Network Components', page='Recommendations')
