...
class HardwareView(BaseView):
    ...
    def list_hardware(self):
        ...
        help = """
            ...
            """
        return self.render_template('single_column_table.html', table_header="hardware</td><td>#Devices</td><td>Average security</td><td>Average reliabilty</td><td>Average management", entries=lines, page_info=help, page_category='Network Components')
    ...
    def show_hardware(self, hardware):
        ...
        help = """
            ...
            """
        return self.render_template('single_column_table.html', table_header=f"Devices with model {hardware}</td><td>Security</td><td>Reliabilty</td><td>Management", entries=lines, page_info=help, page_category='Network Components')
