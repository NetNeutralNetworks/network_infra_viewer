...
class LocationView(BaseView):
    ...
    def show_locations(self, location):
        ...
        """
        return self.render_template('single_column_table.html', table_header=f"Devices located at {location}</td><td>Security</td><td>Reliabilty</td><td>Management", entries=lines, page_info=help, extra_html = location_l2_button, page_category='Network Components')
